...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config_yaml", type=str, required=True, help="path to config yaml")
    parser.add_argument("-k", "--ckpt_path", type=str, required=True, help="path to checkpoint file")
